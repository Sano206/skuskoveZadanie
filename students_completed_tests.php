        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                foreach ($d as $row) {
                    ...
                    echo "<td>" . $row['type'] . "</td>";
                    //MAX POINTS
                    echo "<td>" . $c['points'] . "</td>";   //max pocet bodov otazky

                    //BODOVANIE
                    if ($row['type'] != 'connection') {
                        //SHORT ODPOVEDE BODOVANIE AK SPRAVNE
                        ...
                        //CONNECTION 1. ODPOVED AK SPRAVNE
                        if ($row['question'] == 'answer1') {
                            if (trim($r['answer1']) == trim($row['answer'])) { //AK JE TO SPRAVNA ODPOVED
