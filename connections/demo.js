...
(function () {
    ...
    jsPlumb.ready(function () {
        ...
        instance.batch(function () {
            ...
            //
            var example3Color = "rgb(0,63,255)";
            ...
            //
            // var e5 = instance.addEndpoint("dragDropWindow5", { anchor: [1, 0.5, 1, 0] }, exampleEndpoint);
            // e5.bind("maxConnections", maxConnectionsCallback);
            // instance.addEndpoint("dragDropWindow5", { anchor: [0.25, 0, 0, -1] }, exampleEndpoint2);
            //
            // var e6 = instance.addEndpoint("dragDropWindow6", { anchor: [1, 0.5, 1, 0] }, exampleEndpoint);
            // e6.bind("maxConnections", maxConnectionsCallback);
            // instance.addEndpoint("dragDropWindow6", { anchor: [0.25, 0, 0, -1] }, exampleEndpoint2);
            //
            // var e7 = instance.addEndpoint("dragDropWindow7", { anchor: [1, 0.5, 1, 0] }, exampleEndpoint);
            // e7.bind("maxConnections", maxConnectionsCallback);
            // instance.addEndpoint("dragDropWindow7", { anchor: [0.25, 0, 0, -1] }, exampleEndpoint2);
            //

            var e1 = instance.addEndpoint("dragDropWindow1", exampleEndpoint3);
            e1.bind("maxConnections", maxConnectionsCallback);

            var e2 = instance.addEndpoint("dragDropWindow2", exampleEndpoint3);
            e2.bind("maxConnections", maxConnectionsCallback);

            var e3 = instance.addEndpoint("dragDropWindow3", exampleEndpoint3);
            e3.bind("maxConnections", maxConnectionsCallback);

            var e4 = instance.addEndpoint("dragDropWindow4", exampleEndpoint4);
            e4.bind("maxConnections", maxConnectionsCallback);

            var e5 = instance.addEndpoint("dragDropWindow5", exampleEndpoint4);
            e5.bind("maxConnections", maxConnectionsCallback);

            var e6 = instance.addEndpoint("dragDropWindow6", exampleEndpoint4);
            e6.bind("maxConnections", maxConnectionsCallback);

            var e7 = instance.addEndpoint("dragDropWindow7", exampleEndpoint4);
            e7.bind("maxConnections", maxConnectionsCallback);

            var e8 = instance.addEndpoint("dragDropWindow8", exampleEndpoint4);
